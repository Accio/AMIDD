...
* Offline activities
    ...
    * Read [*Drug discovery effectiveness from the standpoint of therapeutic mechanisms and indications*]({{site.assetbaseurl}}{% link assets/2025/10/Shih-2018-DD-effectiveness-MoA.pdf %}) by Shih *et al.*, Nature Reviews Drug Discovery (2018). Submit your learnings [here via Google Form](https://forms.gle/4rRcCgTq1guDCGTj9) until *December the 4th*.
