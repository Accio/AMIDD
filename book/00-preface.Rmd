...
a system. A statistical model represents assumptions about sample data. It
allows us to use data analysis to infer the distribution of variables of
interest. A computational model implements logic in procedures. It simulates the
behaviour of a system. 

Examples of these models are introduced throughout the book. There are different
views in the literature of philosophy of science about whether statistical and
computational models are special forms of mathematical models or they are
...
molecules alone, the effectiveness of such models will finally be tested in the
body system. Therefore, even if we start by modelling drug molecules, we will
end up modelling body-drug interactions because they form the mechanistic basis
of the therapeutic use of drugs.
...
body-drug interactions offers more than chemical or biological tools that treat
diseases. The tools can be used to interrogate
...
data of the candidate molecules from experiments. Models characterize diseases
as states of the system and encode our understanding of body-drug interactions.
Informed by these models, we use our expertise in chemistry and biology to
change the molecule in order to improve its efficacy and safety profile. In the
next cycle, more experiments further refine the drug candidate, and improved
models update our belief about how the molecule interacts with the body. The
process is repeated until a drug with desired efficacy and safety profiles is
found. 
...
Illumina(R) next-generation sequencing and Nanopore(R) sequencing. We discuss key
...
optimization or even lead to identification of new targets. They can also
...
* At the cellular level, multimodal analysis may associate different aspects of
  cell biology and integrate them into a unified view.
...
* At the population level, digital biomarkers and integration of real-world data
  may allow non-invasive and continuous monitoring of response to drugs. 
