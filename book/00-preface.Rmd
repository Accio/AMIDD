...
This document is also the proposal for *Multiscale Modelling in Drug Discovery: An
...
views in the literature on the philosophy of science about whether statistical and
...
a better understanding of the human body system and more knowledge of diseases
...
Prerequisite is a high-school knowledge of mathematics, chemistry, physics, and
...
* At the cellular level, integration of network modelling, multimodal omics, and
  imaging may associate different aspects of cell biology and integrate them
  into a unified view.
