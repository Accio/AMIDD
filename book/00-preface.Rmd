...
against them. While the history of drug discovery is short, it has fundamentally
...
quantitative methods, in particular mathematical modelling, statistical tools,
and computational methods change our way to finding drugs. We will also
introduce a few important aspects of drug discovery today, especially the choice
of target-based and phenotypic drug discovery, as well as the modalities.
...
#### Chapter six: structure-based modelling {-}
...
#### Chapter seven: ligand-based modelling {-}
...
application in drug discovery. In this chapter, we particularly highlight its
role in ligand-based modelling.
...
probabilistic approaches of analysing biological networks.
