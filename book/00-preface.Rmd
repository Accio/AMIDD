...
### Part I: Overview of drug discovery: the linear view and the multiscale-modelling view {-}
...
popular? What are the advantages of disadvantages of this view?
...
DNA/RNA and RNA/RNA interaction are critical to identify drug candidates with favourable efficacy and toxicity properties. We review key modelling methods here.
...
### Excursion 1: Open-source tools for molecular modelling
...
### Excursion 2: Open-source tools for cellular and omics modelling

1. COPASI
1. Bioconductor
2. Snakemake and nextflow
3. ImageJ
...
#### Chapter seventeen: Population modelling
...
#### Chapter eighteen: real-world data and reverse translation
...
infer efficacy and safety profiles of drugs. Classically, real-world data and clinical data are analysed in a 'for-purpose' fashion. Recently, however, researchers realise the potential to use such data to inform preclinical discovery. We examine key modelling approaches used as well as both opportunities and challenges.

### Excursion 3: Open-source tools for modelling and simulation
...
#### Chapter nineteen: outlook of multiscale modelling
