...
This book aims at providing undergraduate- and graduate-level students
interested in drug discovery an application-oriented introduction. It can also
be used by researchers working in the fields of disease understanding and drug
discovery as a practical guide to mathematical, statistical, and computational modelling.
...
advanced (usually bachelor-level) knowledge if necessary. An appendix is
available to refresh the essential knowledge in mathematics, statistics and
programming that is used throughout the book.
