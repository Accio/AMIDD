...
consider part of it. Example of such sub-systems include the lung infected by
the coronavirus, and a melanoma tissue, a skin cancer that originates from
pigment-producing cells known as melanocytes. From this perspective, health and
diseases are considered as the states of the system. Mathematical, statistical,
and computational models are used to characterize the different states: what
...
In summary, modern drug discovery can be thought as an iterative process
...
and probabilistic approaches to analysing biological sequences, using the
...
structural information can be helpful because it may allow prediction of
...
modelling. Furthermore, we introduce its further applications, including
toxicity prediction and virtual screening.
...
their physico-chemical and biological properties. We highlight key concepts and
approaches of ligand-based modelling, its commonality with and differences from
...
approaches of analysing chemical and biological networks.  Examples include
...
and multimodal analysis, which hold promise for knowledge about disease and
drug-body interaction in individual cells and in interactions between the cells.
...
particular the statistical technique known as non-linear mixed-effect modelling.
