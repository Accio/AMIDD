...
the corona virus, and a melanoma tissue, a skin cancer that originates from
...
to characterize drug-body interactions. From the systems perspective, the goal
...
'health' is defined as its *efficacy profile*. Its capacity of causing harm, known as *adverse effects*, to the whole system is defined as its *toxicity profile*. Equivalently, its capacity of not causing adverse effects is its *safety profile*. Therefore, models also reveal *efficacy and safety profiles* of drug candidates.
...
the drug candidate and we improved models update our belief about
...
Next we focus on cellular level imaging, in particular high-content microscop.
...
actions of drugs, which may offer insight for compoudn optimisation or may even
...
Randomized controlled trial (RCT) is the gold standard of measuing the
...
principles of desining a randomized controlled trial, including statistical
power calculation, randomization, blinding, and causality inference. We will
also examine the common forms of RCTs in drug discovery.
...
collected. Recently, however, researchers realise the potential of such data to
...
scientific fields, molecular modelling in chemitry and material science in
physics, and speculate how drug discovery may learn and benefit from their
approaches. 

Finally, we consider how interdisciplinary multiscale modelling may shape drug discovery in the future. We focus on two aspects: computer-enhanced human cognition and collaboration, uncertainty- and risk-aware decision making. Mathematical, statistical, and computational models, when unified and integrated, may help us identify and build better drug-like molecules faster and cheapter. They may also help us make better decisions that are optimized given facts, uncertainty and risk. If implemented, these measures may revolutionize the way we discover drugs in the future.
