...
* Mathematical, statistical, and computational modelling approaches in drug discovery
...
Modern drug drug discovery, thanks to advances in chemistry, biology, medicine, and
other relevant fields, have largely expanded the search space for matters that
can cure diseases. We are equipped with much more knowledge and better tools
both in the wet labs and in inference and computation. Surprisingly, the
principles of trial-and-error and serendipity are still valid. Nevertheless, our
search for cures is now more focused and more knowledge- and information-driven. 
...
gradually revealed the importance of mathematical and statistical modelling approaches in drug
...
While the history of drug discovery is short, it has fundamentally
improved human health, life quality, and changed the demographic structures of
societies.
