...
* Teaching as a personal choice. My opinions and views do not necessarily reflect those by F. Hoffmann-La Roche, my employer.

* I am neither a mathematician nor a computer scientist by training. I am a computational biologist working in drug discovery. I enjoy mathematics, programming, and  analytical thinking and constantly trying to have fun by applying my hobiies in my work to solve problems.

* I do not think my job here is to teach high mathematics. I am not an expert in mathematics and informatics, but I think I have some experience in drug discovery and in particular how mathematics concepts and informatics tools are used in it. In another word, I am sharing with you what mathematical concepts and computational approaches in drug discovery that I find beautiful, useful, or both.  I look forward to learning from you mathematics that I did not know.

### The format of the course (10 min)
...
* No excercise hours currently. Articles and book chapters for pre-reading and afeter-reading are distributed. Similar for videos. Each of us is encouraged to read them to get an overview of the topic to be covered, and to bring the questions to the course. 
...
5. Why does a bimarker matter besides developing drugs?
...
```{r drugDiscoveryLinear, eval=FALSE, fig.height=8, fig.width=5}
mermaid("
graph TD
...
## Part IV: Drug discovery as a multiscale modelling problem (20 min)
