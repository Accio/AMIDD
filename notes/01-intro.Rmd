...
## Reflecting the linear model 

The linear model of drug discovery is very useful in several aspects.

In reality, drug discovery is rarely linear. Instead, it is often a dynamic and iterative process, with countless variants from the ideal linear model. Rationalized approaches may not always lead to successful drug-discovery projects; and very often. serendipity plays a critical role, especially in the discovery of drugs of new, unexpected mechanisms. 
