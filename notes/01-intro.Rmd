...
* Have a high-level understanding of the drug discovery process
* Become familiar with technical terms, including target identification, screening, lead identification, lead optimization, pre-clinical safety, clinical trials.
...
The last modelling aspect is special: it underlies the three types of models (molecular, cellular and omics, and organ- and system) that we introduced above. Often, we have to reply on the support and the uncertainty measures provided by statistical modelling to gain molecular, cellular and omics, and organ and system level understanding. Beyond that, is used to model populational response to drug treatments, for instance in RCTs.
...
The topic of statistical modelling, especially RCT, and the topics of machine learning and causal inference, will be introduced in the part IV of the course, though statistical thinking and modelling is also demanded in other parts of the course.
