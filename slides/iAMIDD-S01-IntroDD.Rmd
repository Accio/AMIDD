...
Jitao _David_ Zhang, a computational biologist working in drug discovery

Email: \myemail \ or \myrocheemail
...
```{r DNAsegment}
knitr::include_graphics("figures/career-path-with-countries.png")
```
...
* **My opinions and views do not necessarily reflect those by F. Hoffmann-La Roche, my employer**.
...
* Time
* No excerise hour, but pre- and after-reading are recommended.
* Logic of the lecture series.
* Both board and powerpoints are used; lecture notes and powerpoints will be available.
* $\textrm{Note} = 0.2 \times \textrm{Participation} + 0.3 \times \textrm{presentation} + 0.5 \times \textrm{oral examination}$.
* $\textrm{Oral examination} = \textrm{Learning} + \textrm{Explaining your expertise to a layman}$.

## The Herceptin story

Pre-video questions:

* What is the indication of Herceptin? What is the generic (USAN, or United States Adopted Name) name of Herceptin?
* What is the gene that Herceptin targeting at?
* In which year was the target of Herceptin described? And when was Herceptin approved?
* What was the improvement of Herceptin compared with earlier antibodies?
* Why does a bimarker matter besides developing drugs?
* In the clinical trial of herceptin for metastatic breast cancer, how much improvement in the median survival did Herceptin achieve? And how much improvement is in the adjuvant setting (Herceptin applied directly after operation)?
...
1. Name?
2. Subject of study?
3. Which part of mathematics or informatics (or other background) are you mostly interested in?
4. What do you want to take away from the course? Credit points, knowledge in drug discovery, applications of mathematics, or others?
