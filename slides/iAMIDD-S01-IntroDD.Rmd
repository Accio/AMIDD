...
* Structural biology, chemoinformatics and computer-aided drug design
    * Protein structure
    * Molecular modelling
    * Chemoinformatics
    * Quantitative Structure-Activity Relationship (QSAR)
* Mathematical modelling 
    * Mathematical modelling in pharmacology
    * Mathematically modelling for efficacy and for safety
    * Pharmacokinetics (PK) and pharmacodynamics (PD) modelling
    * Modelling in clinical pharmacology and pharmacokinetics
* From bench to bed and back
    * Non-invasive markers: imaging and digital biomarker
    * Clinical trials
    * Real-world data and causal analysis
