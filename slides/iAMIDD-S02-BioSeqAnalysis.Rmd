...
<!-- 
By default, DiagrammeR::grViz(cdgGrFullCode, height=400) won't work.

Either export_svg -> charToRaw -> rsvg_pdf
or use phantomjs (see blow)

https://github.com/rich-iannone/DiagrammeR/issues/133#issuecomment-284370996 -->
...
cdgGrCode <- "DNA -> RNA
  ...
  RNA -> DNA
  RNA -> RNA"
cdgGrFullCode <- paste("digraph{", cdgGrCode, "}")
##DiagrammeR::grViz(cdgGrCode, height=400)
pdf_digraph("cfgraph.pdf", cdgGrCode)
```

## The central dogma, yet again
...
See
https://github.com/rich-iannone/DiagrammeR/issues/133#issuecomment-415121045 -->
```{r cdrTry}
DiagrammeR::grViz(cdgGrFullCode, height=400)
```
