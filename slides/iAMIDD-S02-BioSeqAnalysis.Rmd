...
- Excerise: what is the Levenshtein distance between \newline
\texttt{AATGCTGCTT} and \newline \texttt{AATGCATT}?
...
- Beyond bioinformatics, the Levenshtein distance is often used in computational linguistics and natural language processing, for example in spellchecking.
    - For instance, see the blog post [*How to Write a Spelling Corrector*](http://norvig.com/spell-correct.html) by Peter Norvig.

\takehome{Levenshtein distance can measure distances between biological sequences}
